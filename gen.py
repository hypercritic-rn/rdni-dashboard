...
poapp=G('PO_APP_OPENED');ponoapp=G('PO_NO_APP')
...
h.append('<div class="rc"><h3>Paid but offline &mdash; %s</h3>'%format(PO,','))
h.append('<div class="li"><span><b>Opened the app (last 48h)</b> &mdash; recharged, no internet, actively trying</span><span class="n" style="color:#ff6b70">%s</span></div>'%format(poapp,','))
h.append('<div class="li"><span>No app open &mdash; likely router-off / dormant</span><span class="n mut">%s</span></div>'%format(ponoapp,','))
h.append('<div class="li" style="border-top:1px solid #243342;padding-top:8px"><span style="color:#8aa0b4;font-size:11px">who owns the fix?</span><span></span></div>')
